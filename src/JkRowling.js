...
class JkRowling extends Component {
    ...
    render() {
        ...
        const image = life > 0 ? ( <img className="ko-animation-origin" width="250px" src={jkrowling} alt="jkrowling" />)
        : ( <img className="ko-animation-origin ko-animation" width="250px" src={jkrowling} alt="jkrowling" />);
